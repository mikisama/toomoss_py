...
def LIN_UDS_Response(DevHandle, LINIndex, pUDSAddr, pResData, TimeOutMs):
    return USB2XXXLib.LIN_UDS_Response(
        DevHandle, LINIndex, pUDSAddr, pResData, TimeOutMs
    )


def LIN_UDS_GetMsgFromUDSBuffer(DevHandle, LINIndex, pLINMsg, BufferSize):
    return USB2XXXLib.LIN_UDS_GetMsgFromUDSBuffer(
        DevHandle, LINIndex, pLINMsg, BufferSize
    )
